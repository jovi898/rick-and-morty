...
import 'package:rick_and_morty/features/home/state/home_state.dart';
                ...
                builder: (context, state) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () async {
                      ...
                      await homeCubit.getCharacters();
                      await homeCubit.getFavoriteCharacters();
                    },
                            ...
                            delegate: SliverChildBuilderDelegate((
                              ...
                              if (index <= (state.characters.length - 2)) {
                                ...
                                return CharacterCard(
                                  character: character,
                                  isFavorite: state.favoriteCharacters.contains(
                                    character.id,
                                  ),
                                );
                              } else {
